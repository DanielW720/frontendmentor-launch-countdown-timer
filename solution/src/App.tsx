    ...
    <>
      <main className="min-h-screen overflow-hidden relative min-w-[300px] bg-gradient-to-b from-[#1e1e28] to-[#251c2c]">
        ...
        <img
          src={bgStars}
          alt="Sky of stars"
          className="absolute h-[64vh] z-50 w-full"
        />
        ...
        <div className="absolute bottom-20 left-[30%] flex justify-between w-[40vw] sm:w-[20vw] sm:left-[40%]">
          <a href="#" className="cursor-pointer" aria-label="Facebook">
            <svg
          ...
          <a href="#" className="cursor-pointer" aria-label="Pinterest">
            <svg
              className="text-[#8385A9] fill-current hover:text-[#fb6087]"
              width="24"
              height="24"
          ...
          <a href="#" className="cursor-pointer" aria-label="Instagram">
            <svg
              className="text-[#8385A9] fill-current hover:text-[#fb6087]"
              width="24"
              height="24"
